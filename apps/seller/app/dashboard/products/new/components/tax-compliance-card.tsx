...
export function TaxComplianceCard({
  ...
  return (
    <div id="tax-compliance" className="space-y-4 rounded-xl border border-[#E5E5E0] bg-white p-5 shadow-xs">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <div>
          ...
          <select
            ...
            className={`mt-1.5 h-9 w-full rounded-lg border border-[#E5E5E0] bg-white px-3 text-xs text-[#171717] ${FOCUS_RING}`}
          >
            <option value="12">12% Traditional Crafts / Handicrafts</option>
            <option value="5">5% Handloom & Natural Wood</option>
        ...
        <div>
          ...
          <input
            ...
            placeholder="India"
            className={`mt-1.5 h-9 w-full rounded-lg border border-[#E5E5E0] bg-white px-3 text-xs text-[#171717] placeholder-[#A3A3A3] ${FOCUS_RING}`}
          />
        </div>
      </div>

      {/* Compliance Verification Note */}
      <div className="flex items-center justify-between rounded-lg border border-[#E5E5E0] bg-[#FAF8F5] p-3 text-xs">
