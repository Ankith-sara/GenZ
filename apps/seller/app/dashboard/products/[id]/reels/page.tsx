  ...
  return (
    <div className="max-w-4xl space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="font-nantes text-3xl font-bold text-foreground">
            {product.name} Reels
          </h1>
          <p className="font-graphik mt-1 text-xs text-muted-foreground">
        ...
        <Link
          ...
          className="font-graphik flex items-center gap-1.5 text-xs font-semibold text-foreground hover:text-foreground sm:order-first"
        >
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="rounded-lg border border-border bg-card p-6 shadow-sm sm:p-8">
          <h3 className="font-graphik mb-4 text-[11px] font-semibold tracking-wider text-muted-foreground uppercase">
            Upload Video Reel
          </h3>
        ...
        <div className="rounded-lg border border-border bg-card p-6 shadow-sm sm:p-8 lg:col-span-2">
          <h3 className="font-graphik mb-4 text-[11px] font-semibold tracking-wider text-muted-foreground uppercase">
            Portfolio Stream
          </h3>
