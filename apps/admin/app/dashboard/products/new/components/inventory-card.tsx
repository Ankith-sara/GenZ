...
export function InventoryCard({
  ...
  return (
    <div id="inventory" className="space-y-4 rounded-xl border border-[#E5E5E5] bg-white p-5 shadow-xs">
      <div className="flex items-center justify-between border-b border-[#E5E5E5] pb-3">
        <div>
          ...
          <p className="mt-0.5 text-xs text-[#737373]">
            Track stock levels, SKUs, barcodes, and low stock warnings.
          </p>
        </div>
        ...
        <div>
          ...
          <div className="relative mt-1.5">
            ...
            <input
              ...
              className={`h-9 w-full rounded-lg border border-[#E5E5E5] bg-white pl-9 pr-3 font-mono text-xs text-[#171717] placeholder-[#A3A3A3] ${FOCUS_RING}`}
            />
          </div>
        </div>
