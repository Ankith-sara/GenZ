...
import { signupSeller } from "@/app/signup/seller/actions";
...
describe("signupSeller Server Action", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
