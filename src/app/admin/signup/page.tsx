  ...
  return (
    <main className="min-h-screen bg-forest-green flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10 text-center">
        ...
        <h2 className="text-3xl font-serif text-white font-normal">Register Admin.</h2>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        ...
        <p className="mt-6 text-center text-sm text-white/70">
          ...
          <Link href="/admin/login" className="font-semibold text-gold-yellow hover:underline">
            Sign in
          </Link>
        </p>
      </div>
