...
export function SellerSignupForm() {
  ...
  const [step, setStep] = useState(0); // 0: Select Type, 1-6: Seller Steps, 1: Startup/Artisan
    ...
    return (
      <div className="animate-fade-in py-8 text-center">
        ...
        <p className="mx-auto max-w-md text-sm leading-relaxed text-neutral-600">
          Your seller application has been received and is currently under review by the
          GenZ administration team.
        </p>
        ...
        <div className="mx-auto my-6 max-w-md space-y-2 rounded-lg border border-neutral-200 bg-neutral-50/80 p-5 text-left text-xs leading-relaxed text-neutral-700">
          ...
          <div className="flex items-start gap-2">
            ...
            <span>
              Sign in to your Seller Dashboard anytime to check status and set up your
              products.
            </span>
          </div>
        </div>
        ...
        <div className="mt-6 flex flex-col items-center justify-center gap-3 sm:flex-row">
          ...
          >
            <Link href="/login/seller">Sign In to Dashboard</Link>
          </Button>
          <Button
            asChild
            variant="outline"
  ...
  // REGULAR SELLER (MULTI-STEP)
  const TOTAL_STEPS = 6;
  const isLastStep = step === TOTAL_STEPS;

  return (
    <form action={formAction} noValidate className="animate-fade-in text-left">
      <input type="hidden" name="business_type" value="seller" />
      <input type="hidden" name="role" value="seller" />
